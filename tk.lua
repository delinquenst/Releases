...
local Themes = {
	Blue = {
     ...
     DataTable = Color3.fromRGB(79, 108, 204), 
     DataTableAccent = Color3.fromRGB(255,255,255), 
     Slider = Color3.fromRGB(79, 108, 204), 
     SliderAccent = Color3.fromRGB(235, 235, 235), 
     ToggleAccent = Color3.fromRGB(79, 108, 204), 
     Toggle = Color3.fromRGB(235,235,235),
     Dropdown = Color3.fromRGB(70,100,200),
     DropdownAccent = Color3.fromRGB(235, 235, 235), 
     ColorPicker = Color3.fromRGB(255,255,255),
     ColorPickerAccent = Color3.fromRGB(79, 108, 204),
     TextField = Color3.fromRGB(79, 108, 204),
	...
	Dark = {
		...
		NavBarAccent = Color3.fromRGB(15,15,15),
		NavBarInvert = Color3.fromRGB(20,20,20),
	...
	Red = {
     ...
     Maximise = Color3.fromRGB(200,90,0),
     MaximiseAccent = Color3.fromRGB(200,90,0),
     MainFrame = Color3.fromRGB(130, 47, 47),
     NavBar = Color3.fromRGB(200, 200, 200), 
     NavBarAccent = Color3.fromRGB(154, 52, 52), 
     NavBarInvert = Color3.fromRGB(159, 57, 57), 
     TitleBar = Color3.fromRGB(159, 57, 57),
     TitleBarAccent = Color3.fromRGB(255,255,255),
     Overlay = Color3.fromRGB(130, 47, 47),
     Banner = Color3.fromRGB(255,255,255),
     BannerAccent = Color3.fromRGB(148, 51, 51), 
     Content = Color3.fromRGB(163, 57, 57), 
     Button = Color3.fromRGB(163, 57, 57), 
     ButtonAccent = Color3.fromRGB(235,235,235),
     ChipSet = Color3.fromRGB(163, 57, 57),
     ChipSetAccent = Color3.fromRGB(235,235,235),
     DataTable = Color3.fromRGB(163, 57, 57), 
     DataTableAccent = Color3.fromRGB(255,255,255),
     Slider = Color3.fromRGB(163, 57, 57), 
     SliderAccent = Color3.fromRGB(235, 235, 235), 
     ToggleAccent = Color3.fromRGB(163, 57, 57), 
     Toggle = Color3.fromRGB(235,235,235),
     Dropdown = Color3.fromRGB(70,100,200),
     DropdownAccent = Color3.fromRGB(235, 235, 235), 
     ColorPicker = Color3.fromRGB(255,255,255),
     ColorPickerAccent = Color3.fromRGB(163, 57, 57),
     TextField = Color3.fromRGB(163, 57, 57),
     TextFieldAccent = Color3.fromRGB(235, 235, 235)
	},
}
